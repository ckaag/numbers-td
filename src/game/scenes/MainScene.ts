export class MainScene extends Phaser.Scene {
    ...
    placeTower(pointer: Phaser.Input.Pointer) {
      // Create a tower sprite at the clicked position.
    ...
    getEnemyInRange(tower: Phaser.GameObjects.Sprite): Phaser.GameObjects.Sprite | null {
      const range = tower.getData('range');
      const enemyArray = this.enemies.getChildren() as Phaser.GameObjects.Sprite[];
    ...
    fireBullet(tower: Phaser.GameObjects.Sprite, enemy: Phaser.GameObjects.Sprite) {
